...
cl /O1 /Os /Oi /GS- /std:c++17 /execution-charset:utf-8 /guard:ehcont /Zc:sizedDealloc- /Zc:tlsGuards- /Zc:alignedNew- /arch:IA32 /Z7 /MT /Fo"objs\\%Platform%\\%1" /Zl /c /D__USING_NTDLL_LIB /D "NDEBUG" /D "YY_Thunks_Target=%2" "%~dp0Thunks\YY_Thunks.cpp"
...
call:BuildX 5.2.3790.0 YY_Thunks_for_Win2K3.obj __WindowsNT5_2  PSAPI2Kernel32.def+esent.def+Kernel32.def
if %ErrorLevel% NEQ 0 exit /b %ErrorLevel%
